...
<html>
	...
	<body>
		...
		<div class="back-right">
			<div class="back-goods-update-right">
				<div class="goods-update-title"><span>修改商品</span></div>
				<div class="goods-update-text">
					<form action="" method="post">
						<ul>
							...
							<li>商品类别：<input type="text" id="cate" name="cate" value="" required /></li></li>
							<li>商品图像：<img src="../images/dining/di1.jpg" width="100px" height="100px"></li>
							<li>
