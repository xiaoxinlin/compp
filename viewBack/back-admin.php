			...
			<div class="back-left-nav">
				<ul>
					...
					<li>
						<div class="accordion-group">
							<div class="accordion-heading">
								<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href=""> <a href="../controllers/orderController.php?type=getOrders" class="orders-a">管理订单</a></a>
							</div>
						</div>
					</li>
					<li>
						<div class="accordion-group">
							<div class="accordion-heading">
								<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href=""> <a href="../controllers/goodController.php?type=getGoodList" class="goods-a">管理商品</a></a>
							</div>
						</div>
					</li>
				</ul>
